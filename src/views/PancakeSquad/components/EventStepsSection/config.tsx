...
const stepsConfigBuilder = ({ t, userInfos, eventInfos, userStatus, account, theme, cakeBalance }: EventStepsType) => {
  ...
  return [
    ...
    },
    {
      ...
      title: t('Hold USDTd'),
      bodyText: [t('Each NFT costs USDTd to mint. Remember you also need BNB to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
            href="https://swap.usdt-defi.io/swap?outputCurrency=0x93D00A0fBd822F249458C5f973bee6C5248670a9"
            target="_blank"
            width="100%"
          >
            {t('Buy USDTd')}
