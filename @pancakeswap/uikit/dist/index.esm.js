...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default.createElement(PriceLink, { href: "https://swap.usdt-defi.io/swap?outputCurrency=0x93D00A0fBd822F249458C5f973bee6C5248670a9", target: "_blank" },
...
var lightColors = __assign(__assign(__assign({}, baseColors), additionalColors), { background: "#fff", backgroundDisabled: "#E9EAEB", backgroundAlt: "#FFFFFF", cardBorder: "#53d16E", contrast: "#191326", dropdown: "#53d16E", dropdownDeep: "#EEEEEE", invertedContrast: "#FFFFFF", input: "#53d16E", inputSecondary: "#d7caec", tertiary: "#EFF4F5", text: "#280D5F", textDisabled: "#BDC2C4", textSubtle: "#7A6EAA", disabled: "#E9EAEB", gradients: {
...
var darkColors = __assign(__assign(__assign({}, baseColors), additionalColors), { secondary: "#fff", background: "#53d16E", backgroundDisabled: "#3c3742", backgroundAlt: "#fff", cardBorder: "#fff", contrast: "#FFFFFF", dropdown: "#53d16E", dropdownDeep: "#100C18", invertedContrast: "#191326", input: "#53d16E", inputSecondary: "#262130", primaryDark: "#53d16E", tertiary: "#353547", text: "#fff", textDisabled: "#666171", textSubtle: "#fff", disabled: "#524B63", gradients: {
...
var WebSelector = function () {
    return (React.createElement(Dropdown, { position: "bottom", target: React.createElement(Button, { variant: "text" },
            React.createElement(Text, { color: "textSubtle" },"Network: BSC")) }, [  React.createElement("a", { href:"https://ethswap.usdt-defi.io", style: { minHeight: "32px", height: "auto" } },"ETH")]));
};
        ...
        React__default.createElement(Flex, { flexDirection: "column", width: ["100%", null, "1200px;"] },
            ...
            React__default.createElement(StyledToolsContainer, { order: [1, null, 3], flexDirection: ["column", null, "row"], justifyContent: "space-between" },
                ...
                React__default.createElement(Flex, { order: [1, null, 2], mb: ["24px", null, "0"], justifyContent: "space-between", alignItems: "center" },
                    ...
                    React__default.createElement(Button, { as: "a", href: "https://swap.usdt-defi.io/swap?outputCurrency=0x93D00A0fBd822F249458C5f973bee6C5248670a9", target: "_blank", scale: "sm", endIcon: React__default.createElement(Icon$27, { color: lightColors.backgroundAlt }) }, buyCakeLabel))))));
};
